...
/*        // more button for listView
        ...
        adapter = new StudentWallAdapter(StudentWallActivity.this);
        ...
        session = new SmartSessionManager(StudentWallActivity.this);
                                ...
                                case 1:
                                    ...
                                    try {
                                        ...
                                        for(int i=0; i<jsonArray.length(); i++){
                                            ...
                                            Log.v(Constants.appName, "Post:" +jsonObject.getInt(Constants.postDescription));
