 ...
 */
public class CollegeWallAdapter extends BaseAdapter {
    ...
    // constructor
    public CollegeWallAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if(collegeWallPostsList.get(position).getMediaCount() > 0) {
                ...
                //Log.v(Constants.appName, "Here is the image" + position);
            ...
            holder.postImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(bitmap != null) {
                        ...
                        //largeImageIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
